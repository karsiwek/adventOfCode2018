...
public class day15 {
  ...
  public static String inputMarines =
      "################################\n" +
          "#####################...########\n" +
          "###################....G########\n" +
          "###################....#########\n" +
  ...
  private static String tricky =
      "########## \n" +
          ...
          "#######E## \n" +
          "########## ";
  private void solveShit(String input) {
    ...
    for (int i = 0; i < data.length; i++) {
      for (int j = 0; j < data[i].length; j++) {
        if (data[i][j] == 'G' || data[i][j] == 'E') {
          units.add(new Unit(data[i][j], new Pair(j, i)));
        }
      }
    }
...
//    Collections.copy(stack, closestSorted);
  ...
  public static void main(String[] args) {
    ...
    new day15().solveShit(inputMarines);
  ...
  private class Unit {
    ...
    public Unit(char type, Pair pos) {
      this.type = type;
      this.pos = pos;
    }
